...
app.get("/", (req, res) => {
    res.send({ message: "Connected to Backend server!" }); // returns a message once a GET request to the specified route is made.
});

app.post("/add/item", addItem) // makes a call the addItem function once a POST request to the specified route is made.
